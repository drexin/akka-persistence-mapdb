...
import MapDBJournalSpec._

object MapDBJournalSpec {
  ...
  val config = ConfigFactory.parseString(
    """
      ...
      |mapdb-journal.dir = "target/journal"
    """.stripMargin)
...
class MapDBJournalSpec extends TestKit(ActorSystem("test", config)) with ImplicitSender with WordSpecLike
with Matchers with MapDBCleanup {
